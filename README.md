> [!IMPORTANT]
> **IndexTTS 2.5 vLLM-Omni experiment.** This evaluation fork adds request-local
> precise duration and diffusion controls, a compatibility backend, and
> one-command native deployment with browser-based acceptance testing.
>
> ```bash
> git clone https://github.com/keboqi/indextts-2.5-vllm-omni-experiment.git
> cd indextts-2.5-vllm-omni-experiment
...
> ```
>
> Open `http://SERVER_IP:7860`. No Docker or deployment environment variables
> are required. See the [deployment guide](experiments/indextts25_backend_compat/DEPLOY_WEBUI.md)
> and [compatibility notes](experiments/indextts25_backend_compat/README.md).
> This is not an upstream vLLM-Omni release, and its sentence streaming is
> compatibility streaming rather than native incremental codec output.
